<div class="mb-4">
    <h1 class=" h3 mb-0 text-gray-800">Pendaftaran Pengepul</h1>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nama_pengepul" value="<?= set_value('nama_pengepul') ?>" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="layanan"><?= set_value('layanan') ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Harga Layanan <span class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="harga_pengepul" value="<?= set_value('harga_pengepul') ?>" />
                    </div>
                    <div class="form-group">
